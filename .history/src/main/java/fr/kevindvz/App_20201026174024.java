...
public final class App {
    ...
    public static String numberToText(int number) {
        ...
        String[][] tableauPrincipal = { chiffresTexte, chiffresPremiereDizaine, chiffresDizaineFrom20, grandsNombres };
        if (number == 0) {
            resultat = "zero";
            ...
            while (puissance > 0) {
                ...
                if (puissance % 10 == 0 && puissance > 10) {
                    resultat += Integer.toString(chiffreduRang);
                    resultat += grandsNombres[0] + " and ";
                }
                if (puissance == 10 && chiffreduRang > 1) {
                    resultat += chiffresDizaineFrom20[chiffreduRang] + " ";
                }
                if (puissance == 1) {
                    resultat += chiffresPremiereDizaine[chiffreduRang];
                }
