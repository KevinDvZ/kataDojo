...
public final class App {
    ...
    public static String numberToText(int number) {
        ...
        String[] chiffresDizaineFrom20 = new String[] { "", "twenty", "thirty", "fourty", "fifty", "sixty", "seventy",
                "eighty", "ninety" };
        ...
        if (number == 0) {
            ...
            while (puissance > 0) {
                ...
                if (rang % 3 == 0) {
                    ...
                    resultat += grandsNombres[chiffreduRang] + " and ";
                }
                ...
                // centaine de groupe de 3 digits avec modulo 3 = 2 avec adaptation du chiffre 1
                if (rang % 3 == 2 && chiffreduRang == 1) {
