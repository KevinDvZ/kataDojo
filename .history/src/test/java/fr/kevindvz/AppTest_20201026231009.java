...
class AppTest {
    ...
    void numberToText() {
        ...
        assertEquals(
                "two hundred and ninety-three quadrillion four hundred and ninety-three trillion two hundred and eighty-four billion nine hundred and thirty-two million eight hundred and forty-nine thousand two hundred and forty-eight",
                App.numberToText(293493284932849248));
